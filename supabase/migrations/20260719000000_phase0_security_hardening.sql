...
-- ============================================================
-- 9. Make quote-models bucket private and enforce RLS
-- ============================================================
UPDATE storage.buckets
SET public = false
WHERE id = 'quote-models';

-- Drop any public-read policies that may exist
DROP POLICY IF EXISTS "quote_models_public_read" ON storage.objects;

-- Ensure user isolation policies exist
