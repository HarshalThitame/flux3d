...
export type EmailTemplateCategory =
  "transactional" | "marketing" | "support" | "admin" | "system";
...
export type Database = {
  public: {
    Tables: {
      profiles: {
        Row: ProfileRow;
        Insert: Partial<Omit<ProfileRow, "id">> &
          Pick<ProfileRow, "id" | "email">;
        Update: Partial<ProfileRow>;
      };
      addresses: {
        Row: AddressRow;
        Insert: Omit<Partial<AddressRow>, "id"> &
          Pick<
            AddressRow,
            | "user_id"
            | "full_name"
      ...
      admin_customer_notes: {
        ...
        Insert: Omit<Partial<AdminCustomerNoteRow>, "id"> &
          Pick<AdminCustomerNoteRow, "user_id" | "admin_id" | "note">;
        Update: Partial<AdminCustomerNoteRow>;
      };
      page_visits: {
        Row: PageVisitRow;
        Insert: Omit<Partial<PageVisitRow>, "id"> &
          Pick<PageVisitRow, "session_id" | "page_url">;
        Update: Partial<PageVisitRow>;
      };
      user_sessions: {
        Row: UserSessionRow;
        Insert: Omit<Partial<UserSessionRow>, "id"> &
          Pick<UserSessionRow, "session_id">;
      ...
      feature_usage: {
        Row: FeatureUsageRow;
        Insert: Omit<Partial<FeatureUsageRow>, "id"> &
          Pick<FeatureUsageRow, "feature_name">;
        Update: Partial<FeatureUsageRow>;
      };
      email_logs: {
        Row: EmailLogRow;
        Insert: Omit<Partial<EmailLogRow>, "id"> &
          Pick<
            EmailLogRow,
            "recipient" | "email_type" | "subject" | "template_name"
          >;
        Update: Partial<EmailLogRow>;
      };
      email_events: {
        Row: EmailEventRow;
        Insert: Omit<Partial<EmailEventRow>, "id"> &
          Pick<EmailEventRow, "email_log_id" | "event_type" | "raw_payload">;
        Update: Partial<EmailEventRow>;
      };
      email_templates: {
        Row: EmailTemplateRow;
        Insert: Omit<Partial<EmailTemplateRow>, "id"> &
          Pick<
            EmailTemplateRow,
            "name" | "email_type" | "category" | "subject" | "html_body"
          >;
        Update: Partial<EmailTemplateRow>;
      };
      email_template_versions: {
        Row: EmailTemplateVersionRow;
        Insert: Omit<Partial<EmailTemplateVersionRow>, "id"> &
          Pick<EmailTemplateVersionRow, "template_id" | "version_number">;
        Update: Partial<EmailTemplateVersionRow>;
      };
      email_automation_rules: {
        Row: EmailAutomationRuleRow;
        Insert: Omit<Partial<EmailAutomationRuleRow>, "id"> &
          Pick<
            EmailAutomationRuleRow,
            "event_name" | "template_id" | "target_audience"
          >;
        Update: Partial<EmailAutomationRuleRow>;
      };
      email_queue: {
        Row: EmailQueueRow;
        Insert: Omit<Partial<EmailQueueRow>, "id"> &
          Pick<EmailQueueRow, "template_id" | "recipient" | "status">;
        Update: Partial<EmailQueueRow>;
      };
      email_branding: {
        Row: EmailBrandingRow;
        Insert: Omit<Partial<EmailBrandingRow>, "id"> &
          Pick<EmailBrandingRow, never>;
        Update: Partial<EmailBrandingRow>;
      };
      email_settings: {
        Row: EmailSettingsRow;
        Insert: Omit<Partial<EmailSettingsRow>, "id"> &
          Pick<EmailSettingsRow, never>;
        Update: Partial<EmailSettingsRow>;
      };
      error_logs: {
        Row: ErrorLogRow;
        Insert: Omit<Partial<ErrorLogRow>, "id"> &
          Pick<ErrorLogRow, "error_message">;
        Update: Partial<ErrorLogRow>;
      };
      admin_audit_logs: {
        Row: AdminAuditLogRow;
        Insert: Omit<Partial<AdminAuditLogRow>, "id"> &
          Pick<
            AdminAuditLogRow,
      ...
      whatsapp_rag_answer_audits: {
        ...
        Insert: Omit<Partial<WhatsAppRagAnswerAuditRow>, "id"> &
          Pick<
            WhatsAppRagAnswerAuditRow,
            "question_text" | "retrieval_mode" | "response_kind"
          >;
        Update: Partial<WhatsAppRagAnswerAuditRow>;
      };
      whatsapp_sessions: {
        Row: WhatsAppSessionRow;
        Insert: Pick<WhatsAppSessionRow, "phone_number"> &
          Partial<Omit<WhatsAppSessionRow, "phone_number">>;
        Update: Partial<WhatsAppSessionRow>;
      };
      referrals: {
        Row: ReferralRow;
        Insert: Omit<Partial<ReferralRow>, "id"> &
          Pick<
            ReferralRow,
      ...
      stock_movements: {
        ...
        Insert: Omit<Partial<StockMovementRow>, "id"> &
          Pick<StockMovementRow, "sku_id" | "product_id" | "quantity_delta">;
        Update: Partial<StockMovementRow>;
      };
      stock_alerts: {
        Row: StockAlertRow;
        Insert: Omit<Partial<StockAlertRow>, "id"> &
          Pick<
            StockAlertRow,
            "sku_id" | "product_id" | "alert_type" | "message"
          >;
        Update: Partial<StockAlertRow>;
      };
      shelf_categories: {
        Row: ShelfCategoryRow;
        Insert: Omit<Partial<ShelfCategoryRow>, "id"> &
          Pick<ShelfCategoryRow, "name" | "slug">;
        Update: Partial<ShelfCategoryRow>;
      };
      shelf_products: {
        Row: ShelfProductRow;
        Insert: Omit<Partial<ShelfProductRow>, "id"> &
          Pick<ShelfProductRow, "name" | "slug" | "base_price">;
        Update: Partial<ShelfProductRow>;
      };
      shelf_skus: {
        Row: ShelfSkuRow;
        Insert: Omit<Partial<ShelfSkuRow>, "id"> &
          Pick<ShelfSkuRow, "product_id" | "sku_code" | "price">;
        Update: Partial<ShelfSkuRow>;
      };
      shelf_orders: {
        Row: ShelfOrderRow;
        Insert: Omit<Partial<ShelfOrderRow>, "id"> &
          Pick<
            ShelfOrderRow,
            | "order_number"
            | "items"
      ...
      shelf_reviews: {
        Row: ShelfReviewRow;
        Insert: Omit<Partial<ShelfReviewRow>, "id"> &
          Pick<
            ShelfReviewRow,
      ...
      shelf_coupons: {
        Row: ShelfCouponRow;
        Insert: Omit<Partial<ShelfCouponRow>, "id"> &
          Pick<
            ShelfCouponRow,
            | "code"
            | "discount_type"
      ...
      shelf_review_votes: {
        ...
        Insert: Omit<Partial<ShelfReviewVoteRow>, "id"> &
          Pick<ShelfReviewVoteRow, "review_id" | "user_id" | "is_helpful">;
        Update: Partial<ShelfReviewVoteRow>;
      };
      shelf_review_reminders: {
        Row: ShelfReviewReminderRow;
        Insert: Omit<Partial<ShelfReviewReminderRow>, "id"> &
          Pick<
            ShelfReviewReminderRow,
            "order_id" | "user_id" | "reminder_number"
          >;
