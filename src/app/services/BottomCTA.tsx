      ...
      <Reveal>
        <div className="mx-auto max-w-[760px] text-center">
          ...
          <p className="mx-auto mt-5 max-w-xl text-sm leading-relaxed text-white/70 md:text-base">
            Instant online quoting, material guidance, and quality-checked delivery anywhere in India —
          ...
          <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
            ...
            <a
              href={`https://wa.me/${whatsappNumber}?text=Hi%20Flux3D!%20I%27d%20like%20to%20start%20a%20project.`}
              target="_blank"
