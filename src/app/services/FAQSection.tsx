    ...
    <section ref={ref} className="services-premium-section services-faq-section bg-[#F4F6FA] px-4 py-24 md:px-8 lg:px-16">
      <div className="mx-auto max-w-[960px]">
        ...
        >
          ...
          <h2 className="mx-auto mt-3 max-w-2xl !text-[clamp(2rem,6vw,3rem)] font-extrabold leading-tight !text-[#070b1d] md:!text-5xl">
            ...
            return (
              <div key={faq.question} className="border-b border-slate-100 last:border-b-0">
                <button
                  ...
                  aria-expanded={open}
                >
                  <span className="text-sm font-extrabold leading-6 text-[#070b1d] group-hover:text-[#6d28d9]">{faq.question}</span>
