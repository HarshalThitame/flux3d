    ...
    <section className="relative min-h-[80vh] flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="relative z-10 max-w-[1200px] mx-auto px-6 py-20 text-center">
        ...
        <div className="inline-flex items-center gap-2 bg-[rgba(255,92,26,0.08)] border border-[rgba(255,92,26,0.3)] text-[#FF5C1A] text-sm font-medium px-[1rem] py-[0.35rem] rounded-full mb-6 animate-fadeUp">
          ...
          Precision service for brands, builders, and product teams
        </div>
        ...
        <h1 className="font-[var(--font-syne)] text-[clamp(2rem,5vw,4rem)] font-extrabold text-white leading-[1.1] tracking-[-1px] mb-6 animate-fadeUp" style={{ animationDelay: '0.1s' }}>
          We Print What Others <span className="text-[#FF5C1A]">Can&apos;t</span>
        </h1>

        {/* Subheading */}
        <p className="text-lg text-[#7a82a0] max-w-[600px] mx-auto mb-8 leading-[1.7] animate-fadeUp" style={{ animationDelay: '0.2s' }}>
          From functional prototypes and architecture models to jewellery masters and custom product parts, every build is crafted for speed, precision, and presentation-ready impact.
        </p>

        {/* CTAs */}
        <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fadeUp" style={{ animationDelay: '0.3s' }}>
          <Link href="/instant-quote" className="bg-[#FF5C1A] text-white px-8 py-3 rounded-lg text-base font-medium border-none cursor-pointer transition-transform hover:translate-y-[-2px] hover:opacity-90">
            Get A Free Quote
          </Link>
          <Link href="/materials" className="bg-transparent text-white px-8 py-3 rounded-lg text-base font-medium border border-[rgba(255,255,255,0.07)] cursor-pointer transition-colors hover:border-[rgba(255,255,255,0.25)] hover:bg-[rgba(255,255,255,0.04)]">
            See Materials
          </Link>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-16 animate-fadeUp" style={{ animationDelay: '0.4s' }}>
          <div className="bg-[#0d1120] border border-[rgba(255,255,255,0.07)] rounded-xl p-6">
            ...
            <div className="text-sm text-[#7a82a0] mt-1">Parts Delivered</div>
          </div>
          <div className="bg-[#0d1120] border border-[rgba(255,255,255,0.07)] rounded-xl p-6">
            <div className="font-[var(--font-syne)] text-3xl font-extrabold text-white">
              ±0.05<span className="text-[#FF5C1A]">mm</span>
            </div>
            <div className="text-sm text-[#7a82a0] mt-1">Resin Accuracy</div>
          </div>
          <div className="bg-[#0d1120] border border-[rgba(255,255,255,0.07)] rounded-xl p-6">
            <div className="font-[var(--font-syne)] text-3xl font-extrabold text-white">
