...
export default function MaterialsTech() {
  return (
    <section className="py-24 px-6 bg-gradient-to-b from-transparent via-[rgba(124, 92, 255,0.04)] to-transparent">
      <div className="max-w-[1200px] mx-auto">
        {/* Section header */}
        <div className="text-center mb-16">
          <p className="text-sm font-medium text-[#7C5CFF] uppercase tracking-[3px] mb-4">Materials That Matter</p>
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-[#FFFFFF] border border-[rgba(124, 92, 255,0.5)] rounded-xl p-8">
            <div className="flex items-center gap-4 mb-4">
              <div className="w-12 h-12 rounded-lg bg-[rgba(124, 92, 255,0.08)] flex items-center justify-center">
