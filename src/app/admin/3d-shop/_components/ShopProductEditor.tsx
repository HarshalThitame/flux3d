...
function EditorNav() {
  return (
    <nav className="sticky top-24 hidden w-44 shrink-0 self-start xl:block" aria-label="Editor sections">
    ...
    <div className="space-y-6">
      ...
      <div className="flex gap-10">
        <div className="min-w-0 flex-1 space-y-6">
          <div id="sec-basic" className="scroll-mt-28"><BasicInfoSection /></div>
          <div id="sec-media" className="scroll-mt-28"><MediaGallerySection /></div>
          <div id="sec-model" className="scroll-mt-28"><Model3DSection /></div>
          <div id="sec-hotspots" className="scroll-mt-28"><HotspotSection /></div>
          <div id="sec-variants" className="scroll-mt-28"><VariantOptionsSection /></div>
          <div id="sec-dimensions" className="scroll-mt-28"><DimensionsSection /></div>
          <div id="sec-skus" className="scroll-mt-28"><SkuManagerSection /></div>
          <div id="sec-customization" className="scroll-mt-28"><CustomizationSection /></div>
          <div id="sec-seo" className="scroll-mt-28"><SeoVisibilitySection /></div>
        </div>
        <EditorNav />
      </div>
    </div>
