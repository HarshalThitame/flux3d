...
export type UploadState = Record<
  string,
  { status: "uploading" | "done" | "error"; progress: number }
>;
...
export const emptyProduct: ProductForm = {
  ...
  customization_min_length: 1,
  customization_max_length: 50,
  is_featured: false,
  is_active: false,
  is_archived: false,
  meta_title: "",
...
export const optionTypes: ShopVariantOption["option_type"][] = [
  "button",
  "swatch_color",
  "dropdown",
  "toggle",
...
export function toProductForm(product: ShopProduct): ProductForm {
  return {
    ...
    landscape_image_url: product.landscape_image_url ?? "",
    ...
    sku_pattern: product.sku_pattern ?? "",
    is_customizable: product.is_customizable ?? false,
    customization_label: product.customization_label ?? "",
    customization_is_required: product.customization_is_required ?? false,
    customization_min_length: product.customization_min_length ?? 1,
    customization_max_length: product.customization_max_length ?? 50,
...
export function buildProductPayload(
  ...
  return {
    ...
    landscape_image_url: product.landscape_image_url || null,
    image_urls: product.image_urls,
    image_alt: product.image_alt,
    default_dimensions: product.default_dimensions ?? null,
    model_url: product.model_url || null,
    usdz_url: product.usdz_url || null,
    hotspots: product.hotspots,
    hero_video_url: product.hero_video_url || null,
    base_price: product.base_price,
    sku_pattern: product.sku_pattern || null,
    is_customizable: product.is_customizable,
    customization_label: product.customization_label,
    customization_is_required: product.customization_is_required,
    customization_min_length: product.customization_min_length,
    customization_max_length: product.customization_max_length,
