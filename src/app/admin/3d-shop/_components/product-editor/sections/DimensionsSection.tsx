...
export function DimensionsSection() {
  ...
  return (
    <Section
      title="Dimensions"
      description="Product dimensions are shown to customers and used for shipping calculations."
    >
      ...
      {hasVariants ? (
        <div>
          ...
          <p className="mt-1 text-xs text-[#6F7192]">
            Product dimensions override the default for every SKU that includes the option value.
          </p>
