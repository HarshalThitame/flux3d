  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-[#FFFFFF]">
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute right-0 top-1/4 h-[400px] w-[400px] rounded-full bg-[radial-gradient(circle,rgba(124, 92, 255,0.08),transparent_70%)] blur-[60px]" />
      ...
      <div className="relative z-10 flex min-h-screen flex-col items-center justify-center px-4 pb-16 pt-28 text-[#0F1B3D] md:px-8">
        <motion.div
        ...
        >
          ...
          <h1 className="font-[var(--font-syne)] text-[clamp(2.5rem,6vw,4.5rem)] font-extrabold leading-[0.95] tracking-[-2px] text-[#0F1B3D]">
            Order{' '}
            <span className="bg-[linear-gradient(135deg,#7C5CFF,#A78BFA,#7C5CFF)] bg-clip-text text-transparent">
              Submitted
            </span>
          </h1>
        ...
        >
          <div className="rounded-[28px] border border-[#7C5CFF]/10 bg-[linear-gradient(180deg,rgba(255,255,255,0.96),rgba(255,255,255,0.92))] p-6 shadow-[0_18px_70px_rgba(0,0,0,0.28)]">
        ...
        >
          ...
          >
            ...
            <div className="absolute inset-0 bg-[linear-gradient(135deg,transparent,rgba(124, 92, 255,0.5))]" />
          </Link>
          ...
          >
            ...
            <div className="absolute inset-0 bg-[linear-gradient(135deg,transparent,rgba(124, 92, 255,0.08))]" />
          </Link>
