              ...
              >
                ...
                <div className="relative">
                  <motion.div
                    ...
                    className="text-[11px] uppercase tracking-[0.22em] text-[#FF8A57]"
                  >
                    {item.subtitle}
                  </motion.div>
                  ...
                  <motion.div
                    ...
                    className="mt-10 h-[220px] rounded-[24px] border border-[rgba(255,255,255,0.08)] bg-[linear-gradient(135deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02))]"
                  />
                </div>
              </motion.article>
            ))}
