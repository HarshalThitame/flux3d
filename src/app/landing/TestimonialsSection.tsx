...
function TestimonialCard({ testimonial, index }: { testimonial: typeof testimonials[0]; index: number }) {
  ...
  return (
    <motion.div
      ...
      className="bg-[#faf9f7] border border-[rgba(249, 115, 22,0.5)] rounded-2xl p-8 hover:border-[rgba(249, 115, 22,0.2)] transition-colors"
    >
      {/* Tag */}
      ...
      {/* Author */}
      <div className="flex items-center gap-3 pt-4 border-t border-[rgba(249, 115, 22,0.4)]">
  ...
  return (
    <section ref={ref} className="relative py-24 px-6 overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto relative z-10">
        ...
        >
          <p className="text-sm font-medium text-[#f97316] uppercase tracking-normal mb-4">What Our Customers Say</p>
        ...
        <motion.div
          ...
          className="bg-[#faf9f7] border border-[rgba(249, 115, 22,0.5)] rounded-2xl p-8"
        >
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            ...
            <div>
              <div className="font-[var(--font-syne)] text-2xl font-extrabold text-[#f97316]">100%</div>
