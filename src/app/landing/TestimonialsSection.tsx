  ...
  return (
    <section ref={ref} className="relative py-12 px-6 md:py-16 lg:py-24 overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-8 md:mb-12 lg:mb-16">
          {testimonials.map((t, i) => (
            <Reveal key={i} delay={(i + 1) * 50}>
              <div className="bg-[#faf9f7] border border-[rgba(91,33,182,0.10)] rounded-2xl p-8 hover:border-[rgba(91,33,182,0.18)] hover:-translate-y-1 transition-all duration-200">
        ...
        <Reveal delay={(testimonials.length + 1) * 50}>
          <div className="bg-[#faf9f7] border border-[rgba(91,33,182,0.12)] rounded-2xl p-8">
