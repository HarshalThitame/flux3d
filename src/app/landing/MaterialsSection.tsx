  ...
  return (
    <section ref={ref} className="relative py-12 px-6 md:py-16 lg:py-24 overflow-hidden">
      ...
      <div className="max-w-[1200px] mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-4 mb-8 md:mb-12">
          {materials.map((material, i) => (
            <Reveal key={i} delay={(i + 1) * 40}>
              <div className="group bg-[#faf9f7] border border-[rgba(91,33,182,0.10)] rounded-xl p-6 hover:border-[rgba(91,33,182,0.18)] hover:-translate-y-1 transition-all duration-200">
        ...
        <Reveal delay={(materials.length + 1) * 40}>
          <div className="text-center bg-[#faf9f7] border border-[rgba(91,33,182,0.12)] rounded-2xl p-8">
