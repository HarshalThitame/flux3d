          ...
          <div className="relative z-10">
            ...
            <Reveal delay={220}>
              <div className="mb-8 flex flex-col justify-center gap-4 sm:flex-row">
                <Link
                  href="/contact"
                  className="inline-flex min-h-12 items-center justify-center gap-2 rounded-xl bg-[var(--shop-gold,#C9A962)] px-8 text-sm font-semibold text-[var(--shop-text-primary,#1C1917)] transition hover:bg-[var(--shop-gold-light)]"
                >
                  Contact Sales
            ...
            <Reveal delay={280}>
              <div className="mb-4 flex items-center justify-center gap-4">
                ...
                <span className="text-xs text-[var(--shop-sand,#D7D3CB)] uppercase tracking-[0.14em]">
                  or email us
                </span>
                <div className="h-px w-12 bg-white/20" />
              </div>
