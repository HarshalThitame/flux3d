      ...
      <Reveal className="relative z-10 mx-auto max-w-[1000px]">
        <div className="cta-banner p-6 md:p-10 lg:p-16">
          ...
          <div className="relative z-10">
            <Reveal delay={40}>
              <div className="mb-4 md:mb-6 inline-flex items-center gap-2 rounded-full border border-[#5b21b6]/20 bg-[#f3f0ff] px-4 py-1.5 text-sm font-medium text-[#5b21b6]">
            ...
            <Reveal delay={100}>
              <h2 className="mb-4 font-[var(--font-syne)] text-[clamp(1.8rem,4vw,3rem)] font-extrabold leading-[1.1] text-[#4c1d95]">
                Tell us what you need and we&apos;ll review it before production.
              </h2>
            </Reveal>

            <Reveal delay={160}>
              <p className="mx-auto mb-6 md:mb-8 max-w-[640px] text-base leading-[1.6] text-[#5b21b6]">
            ...
            <Reveal delay={220}>
              <div className="mb-6 md:mb-8 flex flex-col justify-center gap-4 sm:flex-row">
            ...
            <Reveal delay={460}>
              <p className="mt-8 text-xs text-[#7c74b3]">
