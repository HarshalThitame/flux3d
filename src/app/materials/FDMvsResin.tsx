        ...
        <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
          ...
          >
            <div className="mb-5 flex items-center gap-3">
              ...
              <div>
                <h3 className="text-xl font-extrabold text-[#111827]">FDM Printing</h3>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="rounded-2xl bg-[#FAFBFD] p-4">
                ...
                <p className="text-sm font-semibold leading-6 text-[#111827]">Industrial parts, functional prototypes, architecture models, student projects, large prints, outdoor parts</p>
              </div>
            </div>
          </motion.div>
          ...
          >
            <div className="mb-5 flex items-center gap-3">
              ...
              <div>
                <h3 className="text-xl font-extrabold text-[#111827]">Resin Printing</h3>
            ...
            <div className="space-y-3 text-sm">
              ...
              <div className="rounded-2xl bg-[#FAFBFD] p-4">
                <p className="mb-1 text-xs font-bold uppercase text-[#6F7192]">Ideal For</p>
                <p className="text-sm font-semibold leading-6 text-[#111827]">Dental models, jewelry, miniatures, medical models, fine detail props, product presentation models</p>
              </div>
            </div>
          </motion.div>
        </div>
