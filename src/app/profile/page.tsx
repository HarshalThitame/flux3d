    ...
    <div className="min-h-screen bg-[#FFFFFF] px-4 pb-16 pt-28 text-[#0F1B3D] md:px-8">
      ...
      <div className="mx-auto max-w-5xl space-y-6">
        <div className="rounded-[32px] border border-[#7C5CFF]/10 bg-[rgba(255,255,255,0.96)] p-6 backdrop-blur-2xl">
          ...
          <p className="mt-3 max-w-2xl text-base leading-8 text-[#505880]">
        ...
        <div className="grid gap-6 md:grid-cols-[minmax(0,1fr)_320px]">
          <div className="rounded-[28px] border border-[#7C5CFF]/10 bg-gray-50 p-6 backdrop-blur-xl">
            <div className="text-[11px] uppercase tracking-[0.22em] text-[#505880]">Profile details</div>
            <div className="mt-5 grid gap-4">
              <div className="rounded-2xl border border-[#7C5CFF]/10 bg-[#FFFFFF] px-4 py-4">
                <div className="text-xs uppercase tracking-[0.18em] text-[#505880]">Name</div>
                <div className="mt-2 text-sm text-[#0F1B3D]">{auth.profile.name}</div>
              </div>
              <div className="rounded-2xl border border-[#7C5CFF]/10 bg-[#FFFFFF] px-4 py-4">
                <div className="text-xs uppercase tracking-[0.18em] text-[#505880]">Email</div>
                <div className="mt-2 text-sm text-[#0F1B3D]">{auth.profile.email}</div>
              </div>
              <div className="rounded-2xl border border-[#7C5CFF]/10 bg-[#FFFFFF] px-4 py-4">
                <div className="text-xs uppercase tracking-[0.18em] text-[#505880]">Member since</div>
          ...
          <div className="space-y-6">
            <div className="rounded-[28px] border border-[#7C5CFF]/10 bg-gray-50 p-6 backdrop-blur-xl">
              <div className="text-[11px] uppercase tracking-[0.22em] text-[#505880]">Usage snapshot</div>
              <div className="mt-4 font-[var(--font-syne)] text-4xl font-extrabold text-[#0F1B3D]">
                {count ?? 0}
              </div>
              <div className="mt-2 text-sm text-[#505880]">
            ...
            <div className="rounded-[28px] border border-[#7C5CFF]/20 bg-[#7C5CFF]/8 p-6">
              ...
              <p className="mt-3 text-sm leading-7 text-[#505880]">
                Need to rotate credentials or test recovery? Use the password reset flow from the login screen.
              </p>
              <Link
                href="/saved-quotes"
                className="mt-5 inline-flex rounded-2xl bg-white px-4 py-3 text-sm font-medium text-[#0F1B3D]"
              >
                Review saved quotes
              </Link>
            </div>
