...
export default function AboutContent() {
  ...
  return (
    <div className="overflow-hidden">
      ...
      >
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_50%_30%,rgba(255,92,26,0.08)_0%,transparent_70%)] pointer-events-none" />
        
        <div className="max-w-4xl mx-auto relative z-10">
          <motion.p
            variants={fadeInUp}
            className="text-[#FF5C1A] text-sm font-semibold tracking-[3px] uppercase mb-6"
          >
            About Flux 3D
          </motion.p>
          ...
          >
            ...
            <br />
            <span className="text-[#7a82a0] font-normal text-[clamp(1.2rem,3vw,2rem)]">
      ...
      >
        <div className="max-w-5xl mx-auto">
          <motion.div variants={fadeInUp} className="mb-12">
            <span className="text-[#FF5C1A] text-sm font-semibold tracking-[3px] uppercase">Who We Are</span>
            <h2 className="font-[var(--font-syne)] text-[clamp(1.8rem,4vw,3rem)] font-extrabold text-white mt-4 leading-[1.2]">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <motion.div variants={fadeInUp} className="space-y-4">
              ...
              <p className="text-[#7a82a0] leading-[1.8]">
                ...
                <span className="text-[#FF5C1A] font-medium">Bambu Lab printers</span> to deliver 
                parts, prototypes, and products with tolerances and surface finishes that look 
                as good as they perform.
              </p>
            </motion.div>
            
            <motion.div variants={fadeInUp} className="bg-[#0d1120] border border-white/[0.07] rounded-2xl p-6">
              <h3 className="font-[var(--font-syne)] text-lg font-bold text-white mb-4">Our Mission</h3>
              <p className="text-[#7a82a0] leading-[1.8] mb-4">
      ...
      >
        <div className="max-w-6xl mx-auto">
          <motion.div variants={fadeInUp} className="text-center mb-16">
            <span className="text-[#FF5C1A] text-sm font-semibold tracking-[3px] uppercase">Why Flux 3D?</span>
            <h2 className="font-[var(--font-syne)] text-[clamp(1.8rem,4vw,3rem)] font-extrabold text-white mt-4 leading-[1.2]">
              Built Different.{' '}
          ...
          <motion.div variants={staggerContainer} className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {whyChooseUs.map((item, i) => (
              <motion.div
                ...
                className="group relative bg-[#0d1120] border border-white/[0.07] rounded-2xl p-6 hover:border-[rgba(255,92,26,0.3)] transition-all duration-300"
              >
                ...
                <p className="text-sm text-[#7a82a0] leading-[1.7]">
                  {item.description}
                </p>
              </motion.div>
            ))}
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          <span className="text-[#FF5C1A] text-sm font-semibold tracking-[3px] uppercase">What We Print</span>
          <h2 className="font-[var(--font-syne)] text-[clamp(1.8rem,4vw,3rem)] font-extrabold text-white mt-4 mb-12 leading-[1.2]">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {printTypes.map((type, i) => (
              <motion.span
                ...
                className="text-sm bg-[#0d1120] border border-white/[0.07] text-[#7a82a0] px-4 py-2 rounded-full hover:border-[#FF5C1A]/30 hover:text-white transition-colors"
              >
                {type}
              </motion.span>
            ))}
      ...
      >
        <div className="max-w-5xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <span className="text-[#FF5C1A] text-sm font-semibold tracking-[3px] uppercase">Our Values</span>
              <h2 className="font-[var(--font-syne)] text-[clamp(1.8rem,4vw,3rem)] font-extrabold text-white mt-4 mb-6 leading-[1.2]">
                Principles That{' '}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF5C1A] to-[#ff7a3d]">
                  Drive Us.
                </span>
            ...
            <div className="space-y-4">
              {values.map((value, i) => (
                <motion.div
                  ...
                  className="flex items-start gap-4 bg-[#0d1120] border border-white/[0.07] rounded-xl p-4"
                >
                  <div className="w-10 h-10 rounded-lg bg-[#FF5C1A]/10 flex items-center justify-center flex-shrink-0">
                    <value.icon className="w-5 h-5 text-[#FF5C1A]" />
                  </div>
                  <p className="text-[#e8eaf0] leading-[1.6] pt-2">{value.text}</p>
                </motion.div>
              ))}
            </div>
          </div>
      ...
      >
        <div className="max-w-4xl mx-auto">
          <div className="bg-[#0d1120] border border-white/[0.07] rounded-3xl p-8 md:p-12">
            <span className="text-[#FF5C1A] text-sm font-semibold tracking-[3px] uppercase">The Flux Story</span>
            <h2 className="font-[var(--font-syne)] text-[clamp(1.5rem,3vw,2.5rem)] font-extrabold text-white mt-4 mb-6 leading-[1.2]">
              Born From Frustration.{' '}
              <span className="text-[#7a82a0]">Built For You.</span>
            </h2>
          ...
          >
            {stats.map((stat, i) => (
              <motion.div
                key={i}
                variants={fadeInUp}
                className="text-center bg-[#0d1120] border border-white/[0.07] rounded-2xl p-6 hover:border-[#FF5C1A]/30 transition-colors"
              >
                <div className="text-4xl mb-3">{stat.icon}</div>
                <div className="font-[var(--font-syne)] text-3xl md:text-4xl font-extrabold text-white mb-2">
                  {stat.value}
                </div>
      ...
      >
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_50%_at_50%_50%,rgba(255,92,26,0.08)_0%,transparent_70%)] pointer-events-none" />
        
        <div className="max-w-3xl mx-auto relative z-10">
          <h2 className="font-[var(--font-syne)] text-[clamp(1.8rem,5vw,3.5rem)] font-extrabold text-white mb-6 leading-[1.1]">
            Ready to Bring Your{' '}
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF5C1A] to-[#5064FF]">
              Design to Life?
            </span>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a
              href="/gallery"
              className="inline-flex items-center justify-center gap-2 border border-white/[0.1] bg-white/[0.03] text-white px-8 py-4 rounded-xl text-lg font-semibold hover:bg-white/[0.07] transition-colors"
            >
              See Our Work →
            </a>
          </div>
