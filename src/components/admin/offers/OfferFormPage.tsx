...
export default function OfferFormPage({ offerId }: { offerId: string }) {
      ...
      .then((d) => {
        ...
        setForm({
          ...
          starts_at: o.starts_at
            ? new Date(o.starts_at).toISOString().slice(0, 16)
            : "",
          ends_at: o.ends_at
            ? new Date(o.ends_at).toISOString().slice(0, 16)
            : "",
  ...
  const update = useCallback(
    (key: keyof OfferForm, value: string | number | boolean) => {
  ...
  async function uploadBanner(
    ...
    try {
      ...
      body.append("productId", "offer-banners");
      const res = await fetch("/api/3d-shop/admin/upload", {
        method: "POST",
        body,
      });
  ...
  async function handleSave() {
    ...
    const body = {
      ...
      applicable_categories: form.applicable_categories
        ? form.applicable_categories
            ...
            .filter(Boolean)
        : null,
      applicable_materials: form.applicable_materials
        ? form.applicable_materials
            .split(",")
            .map((s) => s.trim())
            .filter(Boolean)
        : null,
    ...
    try {
      const res = await fetch(
        isNew ? "/api/admin/offers" : `/api/admin/offers/${offerId}`,
        {
  ...
  const inputClass =
    "w-full px-3 py-2.5 rounded-xl border border-[rgba(109, 40, 217,0.2)] bg-white text-sm text-[#0F1B3D] outline-none focus:border-[#6d28d9] transition-colors";
    ...
    <div>
      ...
      <div className="space-y-6 max-w-3xl">
        ...
        <div className={rowClass}>
          <div>
            ...
            <input
              ...
              onChange={(e) => update("max_discount", Number(e.target.value))}
              className={inputClass}
              min={0}
            />
          </div>
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                update("min_order_value", Number(e.target.value))
              }
              className={inputClass}
              min={0}
            />
        ...
        <fieldset className="border border-[rgba(109, 40, 217,0.15)] rounded-2xl p-5">
          <legend className="text-sm font-semibold text-[#0F1B3D] px-2">
            Display Settings
          </legend>
            ...
            <div className={rowClass}>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => update("sale_label", e.target.value)}
                  className={inputClass}
            ...
            <div className="flex items-center gap-6">
              <label className="flex items-center gap-2 text-sm text-[#0F1B3D] cursor-pointer">
                <input
                  ...
                  className="rounded border-[rgba(109, 40, 217,0.3)] text-[#6d28d9]"
                />
            ...
            <div className={rowClass}>
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    update("usage_limit", Number(e.target.value))
                  }
                  className={inputClass}
                  min={0}
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    update("usage_per_user", Number(e.target.value))
                  }
                  className={inputClass}
                  min={0}
                />
        ...
        <fieldset className="border border-[rgba(109, 40, 217,0.15)] rounded-2xl p-5">
          ...
          <p className="text-xs text-[#6F7192] mb-3">
            Leave empty to apply to all. Separate values with commas.
          </p>
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  update("applicable_categories", e.target.value)
                }
                className={inputClass}
                placeholder="Prototypes, Machine Parts, ..."
              />
            </div>
            <div className={rowClass}>
              <div>
                ...
                <input
                  type="text"
                  value={form.applicable_materials}
                  onChange={(e) =>
                    update("applicable_materials", e.target.value)
                  }
                  className={inputClass}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    update("applicable_products", e.target.value)
                  }
                  className={inputClass}
