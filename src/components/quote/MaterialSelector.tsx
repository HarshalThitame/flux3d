...
export default function MaterialSelector({
  ...
  return (
    <div className="space-y-4">
      <div>
        <div className="text-sm font-medium text-[#070b1d]">Material Selection</div>
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-center justify-between gap-3">
                  <div className="font-medium text-[#070b1d]">{material.name}</div>
      ...
      <div className="rounded-[24px] border border-[#6d28d9]/10 bg-[var(--bg-elevated)] p-4">
        <div className="text-sm font-medium text-[#070b1d]">Color Selection</div>
            ...
            <button
              ...
              className={`rounded-full border px-4 py-2 text-sm transition-colors ${
                selectedColor === color.name
                  ...
                  : 'border-[#6d28d9]/10 bg-white text-[var(--text-secondary)] hover:text-[#070b1d]'
              }`}
            >
              {color.name}
            </button>
