          ...
          <div className="mb-8 flex flex-col gap-5 xl:flex-row xl:items-end xl:justify-between">
            <div className="max-w-[760px]">
              ...
              <p className="mt-5 max-w-[720px] text-base leading-8 text-[#6F7192]">
                Review your cart items, choose a saved address or add a new one,
                and we will calculate shipping automatically before your order
                is sent.
              </p>
            </div>
            ...
            >
              <div className="mb-5 flex items-start justify-between gap-4">
                <div>
                  ...
                  <p className="mt-2 text-sm leading-6 text-[#6F7192]">
                    Final review before your {items.length} item
                    {items.length !== 1 ? "s are" : " is"} submitted.
                  </p>
                </div>
                <div className="rounded-2xl border border-[#6d28d9]/20 bg-[#6d28d9]/10 p-3 text-[#6d28d9]">
                    ...
                    {summary.couponDiscountAmount > 0 &&
                      summary.appliedCoupon && (
                        <div className="flex justify-between text-emerald-700">
                          ...
                          <span>
                            -₹{summary.couponDiscountAmount.toFixed(2)}
                          </span>
                        </div>
                      )}
                    {summary.offerDiscountAmount > 0 &&
                      summary.appliedOffer && (
                        <div className="flex justify-between text-emerald-700">
                          <span>Offer ({summary.appliedOffer.title})</span>
                          <span>
                            -₹{summary.offerDiscountAmount.toFixed(2)}
                          </span>
                        </div>
                      )}
                    <div className="flex justify-between">
