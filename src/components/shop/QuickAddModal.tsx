              ...
              <div className="flex min-w-0 gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-sm text-[var(--shop-text-secondary)]">
                    {formatShopPrice(
                      resolvedSku?.price ?? product.display_price,
                    )}
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between gap-4 rounded-2xl border border-[var(--shop-border-light)] bg-white p-4">
                <div>
                  <div className="font-semibold text-[var(--shop-text-primary)]">
                    {resolvedSku
                      ? formatShopPrice(resolvedSku.price)
                      : `From ${formatShopPrice(product.display_price)}`}
                  </div>
                  <div className="text-sm text-[var(--shop-text-muted)]">
                    {stock.label}
                  </div>
                </div>
                <QuantityStepper
