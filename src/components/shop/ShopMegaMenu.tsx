...
export default function ShopMegaMenu({ categories, onClose }: { categories: ShopPublicCategory[], onClose: () => void }) {
  if (!categories || categories.length === 0) return null

  // Render up to 2 levels deep in the mega menu for a clean UI
  return (
    <div className="absolute left-0 top-full mt-2 w-screen max-w-[800px] overflow-hidden rounded-2xl bg-white p-6 shadow-2xl ring-1 ring-black/5" style={{ transform: 'translateX(-20%)' }}>
