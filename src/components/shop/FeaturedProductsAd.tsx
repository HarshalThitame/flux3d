        ...
        <div className="p-3 space-y-2 bg-white">
          ...
          {product.review_count > 0 && (
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-xs font-semibold text-[var(--shop-text-primary)]">
          ...
          <div className="flex items-baseline gap-1.5">
            <span className="text-base font-semibold text-[var(--shop-text-primary)]">
    ...
    async function loadProducts() {
      ...
      try {
        ...
        const response = await fetch(
          `/api/3d-shop/recommendations?${params.toString()}`,
        );
    ...
    <section className="mt-6">
      ...
      >
        ...
        <div className="relative flex items-center gap-2.5">
          ...
          <div>
            <h2 className="text-base font-semibold text-[var(--shop-text-primary)]">
              You Might Also Love
            </h2>
            <p className="text-[10px] font-medium text-[var(--shop-text-muted)]">
              Curated picks based on your order
            </p>
          </div>
        </div>
      </motion.div>
