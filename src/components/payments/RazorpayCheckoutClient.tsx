...
export default function RazorpayCheckoutClient({
  ...
  return (
    <>
      ...
      <div
        className="flex h-full flex-col p-5 shadow-[var(--shop-shadow-lg)]"
        style={{
        ...
        >
          <div className="flex items-start justify-between gap-4">
            <div>
              ...
              <h2 className="mt-4 text-2xl font-black tracking-tight text-[var(--shop-text-primary,#070b1d)]">
                {title}
              </h2>
              <p className="mt-2 text-sm leading-7 text-[var(--shop-text-muted,#6b7280)]">
                {subtitle}
              </p>
            </div>
            <div
            ...
            >
              <div className="text-[10px] font-bold uppercase tracking-[0.18em] text-[var(--shop-text-muted,#6b7280)]">
                Amount
              </div>
              <div className="mt-1 text-xl font-black text-[var(--shop-text-primary,#070b1d)]">
                {amountDisplay}
              </div>
            </div>
          </div>
          ...
          <div
            ...
            style={{
              border: `1px solid ${theme.containerBorder}`,
              backgroundColor: `${theme.accentFaint}80`,
            }}
          >
            {orderSummary}
          </div>
          ...
          <div
            className="mt-5 rounded-3xl p-4 text-sm leading-7 text-[#374151]"
            style={{
              border: `1px solid ${theme.containerBorder}`,
              backgroundColor: theme.accentFaint,
            }}
          >
            <div className="font-bold text-[var(--shop-text-primary,#070b1d)]">
              What happens next
            </div>
            <ul className="mt-2 space-y-2">
              ...
              <li className="flex items-start gap-2">
                ...
                Flux3D verifies the signature and waits for capture
                confirmation.
              </li>
              <li className="flex items-start gap-2">
                <span
          ...
          <button
            ...
            onMouseEnter={(e) => {
              if (!loading && status !== "verifying" && status !== "paid")
                (e.currentTarget as HTMLButtonElement).style.backgroundColor =
                  theme.buttonHoverBg;
            }}
            onMouseLeave={(e) => {
          ...
          <div
            className="mt-4 rounded-2xl p-4 text-xs leading-6 text-[var(--shop-text-muted,#6b7280)]"
            style={{
              border: `1px solid ${theme.containerBorder}`,
              backgroundColor: theme.accentFaint,
            }}
          >
            ...
            <div className="mt-2 text-[var(--shop-text-muted,#6b7280)]">
              Order reference {orderNumber}. Secure verification is handled on
              Flux3D servers.
            </div>
          </div>
        </div>
