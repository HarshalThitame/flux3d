...
export const adminNavItems: NavItem[] = [
  ...
  { label: 'Production', href: '/admin/production', icon: Factory, section: 'main' },
  { label: 'Fulfillment', href: '/admin/fulfillment', icon: Package, section: 'main' },
  { label: 'Custom Orders', href: '/admin/custom-orders', icon: ShoppingCart, section: 'main' },
