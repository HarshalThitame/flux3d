...
export const postProcessingOptions: Array<{
  ...
  { value: "none", label: "None", description: "Raw part, no finishing work." },
  {
    value: "sanded",
    label: "Sanded",
    description: "Sanding for a smoother finish.",
  },
  {
    value: "sanded-painted",
    label: "Sanded + Painted",
    description: "Sanding, primer, and paint-ready finishing.",
  },
];
...
export function getPostProcessingCharge(
  ...
  return calculateConfiguredPostProcessingCharge(
    level,
    baseAmount,
    difficultyFactor,
    multipliers,
...
function legacySettings(
  ...
  return {
    ...
    amsColorChangeSurcharge: FALLBACK_SETTINGS.amsColorChangeSurcharge,
  };
}
...
export function calculateInstantQuote(
  ...
  const settings =
    typeof settingsOrMargin === "number"
