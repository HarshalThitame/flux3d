...
import type { EmailVerificationPayload } from '../types'
...
export default function EmailVerificationEmail({
  ...
  return (
    <Html lang="en">
      ...
      <Preview>Verify your email address to activate your Flux3D account.</Preview>
      <Body className="email-bg" style={{ backgroundColor: '#f3f4f6', margin: 0, padding: '24px 0', fontFamily: 'sans-serif' }}>
        <Container style={{ maxWidth: 600, margin: '0 auto', backgroundColor: '#ffffff', borderRadius: 12, padding: 32 }}>
          ...
          <Section style={{ textAlign: 'center', margin: '24px 0' }}>
            <Button href={verificationUrl} style={{ backgroundColor: PRIMARY, color: '#fff', padding: '14px 24px', borderRadius: 8, fontSize: 15, fontWeight: 600, textDecoration: 'none', display: 'inline-block' }}>
              Verify Email Address
            </Button>
          </Section>
          <Text style={{ fontSize: 13, color: '#6b7280', textAlign: 'center' }} className="email-muted">
            If you didn't create an account, you can safely ignore this email. Questions?{' '}
