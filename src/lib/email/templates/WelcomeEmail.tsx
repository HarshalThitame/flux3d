...
export default function WelcomeEmail({ customerName }: WelcomeEmailPayload) {
  return (
    <Html lang="en">
      <Head>
      ...
      <Preview>Welcome to Flux3D — let's build something amazing together.</Preview>
      <Body className="email-bg" style={{ backgroundColor: '#f3f4f6', margin: 0, padding: '24px 0', fontFamily: 'sans-serif' }}>
        <Container style={{ maxWidth: 600, margin: '0 auto', backgroundColor: '#ffffff', borderRadius: 12, padding: 32 }}>
          ...
          <Text style={{ fontSize: 22, fontWeight: 700, color: '#1a1a1a' }} className="email-text">Welcome aboard, {customerName}!</Text>
          ...
          <Section style={{ textAlign: 'center', margin: '24px 0' }}>
            <Button href="https://flux3d.in/upload" style={{ backgroundColor: PRIMARY, color: '#fff', padding: '14px 24px', borderRadius: 8, fontSize: 15, fontWeight: 600, textDecoration: 'none', display: 'inline-block' }}>
              Upload Your First Model
            </Button>
          </Section>
          <Text style={{ fontSize: 13, color: '#6b7280', textAlign: 'center' }} className="email-muted">
            Questions? Reach us at <Link href="mailto:support@flux3d.in" style={{ color: SECONDARY }}>support@flux3d.in</Link>
          </Text>
        </Container>
      </Body>
    </Html>
