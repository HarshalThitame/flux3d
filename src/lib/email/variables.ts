...
export const KNOWN_VARIABLES: Record<string, EmailVariableMeta[]> = {
  ...
  review_thank_you: [
    { name: 'customer_name', description: 'Customer name', example: 'Rutik' },
    { name: 'product_name', description: 'Name of the reviewed product', example: 'RGB Lotus Flower Lamp' },
    { name: 'product_url', description: 'Link to the reviewed product page', example: 'https://flux3d.in/3d-shop/product/rgb-lotus-lamp' },
  ],
  payment_receipt: [
    { name: 'customer_name', description: 'Customer name', example: 'Rutik' },
    { name: 'order_number', description: 'Order number', example: 'F3D-2026-001234' },
...
export const EMAIL_TYPE_META: Record<string, { category: string; description: string; subject: string }> = {
  ...
  review_thank_you: { category: 'transactional', description: 'Thank-you note after a customer submits a product review', subject: 'Thanks for your review, {{customer_name}}! 💜' },
